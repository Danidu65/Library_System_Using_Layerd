...
public class ReturnModel {
    ...
    public static IssueDTO Search(String searchId) throws SQLException {
    ...
    public static ArrayList<ReturnDTO> loadAllReturns() throws SQLException {
        Connection con = DBConnection.getInstance().getConnection();
        ...
        ArrayList<ReturnDTO> returns1 = new ArrayList<>();
