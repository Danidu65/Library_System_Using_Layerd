...
public class SupliersModel {
    ...
    public static boolean Save(SuplierDTO suplier) throws SQLException {
    ...
    public static SuplierDTO Search(String searchId) throws SQLException {
        Connection con = DBConnection.getInstance().getConnection();
    ...
    public static Boolean Update(SuplierDTO suplier) throws SQLException {
        Connection con = DBConnection.getInstance().getConnection();
    ...
    public static ArrayList<SuplierDTO> LoadAllSupplier() throws SQLException {
        Connection con = DBConnection.getInstance().getConnection();
