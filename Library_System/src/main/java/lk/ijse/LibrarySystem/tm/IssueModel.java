...
public class IssueModel {
    ...
    public static boolean Issues(IssueDTO issuse, String qty, String bookID) throws SQLException {
    ...
    public static ArrayList<IssueDTO> loadAllIssuse() throws SQLException {
    ...
    public static IssueDTO IssuseSearch(String iid) throws SQLException {
