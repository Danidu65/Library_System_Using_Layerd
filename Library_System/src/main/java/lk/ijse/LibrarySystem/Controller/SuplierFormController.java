...
public class SuplierFormController implements Initializable {
    ...
    @FXML
    private TableView<SuplierDTO> table;

    @FXML
    private TableColumn<SuplierDTO,String> tblId;

    @FXML
    private TableColumn<SuplierDTO,String> tblName;

    @FXML
    private TableColumn<SuplierDTO,String> tblContact;

    @FXML
    private TableColumn<SuplierDTO,String> tblAddress;

    @FXML
    private TableColumn<SuplierDTO,String> tblSuplierBook;
    ...
    void search(ActionEvent event) throws SQLException {
        String searchId = SearchId.getText();
        SuplierDTO suplier = SupliersModel.Search(searchId);
    ...
    public void loadTable() throws SQLException {
        ArrayList<SuplierDTO> supplier = SupliersModel.LoadAllSupplier();
