...
import lk.ijse.LibrarySystem.bo.impl.PublisherBOImpl;
...
public class PublisherFormController implements Initializable {
    ...
    @FXML
    private JFXComboBox<PublisherDTO> cmbPublishedBook;

    @FXML
    private TableView<PublisherDTO> table;

    @FXML
    private TableColumn<PublisherDTO, String> tblPublisherId;

    @FXML
    private TableColumn<PublisherDTO, String> tblPublisherName;

    @FXML
    private TableColumn<PublisherDTO, String> tblBookName;

    @FXML
    private TableColumn<PublisherDTO, String> tblPublishedYear;

    PublisherBOImpl publisherBO = new PublisherBOImpl();

    @FXML
    void delete(ActionEvent event) throws SQLException, ClassNotFoundException {
        String searchId = txtSearchId.getText();
        boolean delete = publisherBO.publisherDelete(searchId);
        LoadTable();
    ...
    void search(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        Publisher publisher = publisherBO.publisherSearch(searchId);
    ...
    void update(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        boolean p1 = publisherBO.publisherUpdate(publisher);
        LoadTable();
    ...
    void save(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        boolean a1 = publisherBO.publisherAdd(publisher);
        LoadTable();
    ...
    public void LoadTable() throws SQLException, ClassNotFoundException {
        ArrayList<PublisherDTO> publisher = PublisherModel.LoadAllPublishers();
    ...
    private void setTurnId() throws SQLException, ClassNotFoundException {
        String newTurnId = publisherBO.publisherGenarateTurnID();
