...
public class MemberFormController implements Initializable {
    ...
    @FXML
    private TableColumn<MemberDTO, String> tblMemberId;

    @FXML
    private TableColumn<MemberDTO, String> tblMemberName;

    @FXML
    private TableColumn<MemberDTO, String> tblMemberAddress;

    @FXML
    private TableColumn<MemberDTO, String> tblMemberContact;

    @FXML
    private TableColumn<MemberDTO, String> tblMemberEmail;
    ...
    void SEARCH(ActionEvent event) throws SQLException {
        ...
        MemberDTO member = MemberModel.Search(searchId);
    ...
    public void loadTable() throws SQLException {
        ArrayList<MemberDTO> members = MemberModel.LoadAllMembers();
