...
import lk.ijse.LibrarySystem.bo.custom.MemberBO;
import lk.ijse.LibrarySystem.dao.custom.impl.MemberDAOImpl;
...
public class MemberBOImpl implements MemberBO {
    ...
    public boolean memberAdd(MemberDTO member) throws SQLException, ClassNotFoundException {
        return memberDAO.add(new Member(member.getId(), member.getName(),
                member.getAddress(), member.getContact(), member.getEmail(), member.getGender()));
    }
